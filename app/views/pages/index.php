  ...
  <body>
    ...
    <section class="section gutter sec-partners" data-pg-collapsed>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-4">
            <a class="btn mt-20" href="#!">Become A Partner</a>
          </div>
        </div>
      </div>
    </section>
    ...
    Get Fuel Product Delivered at Your Door Step.Fill in the Details to Buy.</h6>
              ...
              <div class="row" data-pg-collapsed>
                <div class="col-md-4">
                  <div class="form-group" data-pg-collapsed>
                    ...
                    <select class="form-control" id="products" name="products">
                      <option value="-1" selected>-- Select Products --</option>
                ...
                <div class="col-md-4">
                  <div class="form-group" data-pg-collapsed>
                    <label class="control-label" for="price">Amount ( NGN )</label>
                ...
                <div class="col-md-4">
                  <div class="form-group" data-pg-collapsed>
                    ...
                    <input type="number" class="form-control" id="litres" name="litres" placeholder="Liters">
                    <span class="invalid-feedback"><?php echo $data['litres_err'];?></span>
                  </div>
                </div>
              </div>
              <div class="row" data-pg-collapsed>
                <div class="col-xs-12">
                  <h6 class="text-right"><a href="#" id="addprod">Add Another Product</a></h6>
                </div>
              </div>
              <h3>Your Details</h3>
              <div class="row">
                ...
                <div class="col-xs-12" data-pg-collapsed>
                  <div class="form-group">
                    ...
                    <span class="invalid-feedback"><?php echo $data['deliveryadd_err'];?></span>
                  </div>
                </div>
              </div>
              <h3 class="text-right">Proceed to Checkout<button type="submit" id="checkout" class="checkout-btn">
                  <i class="fa fa-fw fa-long-arrow-right"></i>
                </button></h3>
            </form>
          </div>
          <!-- <div class="col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2 col-xs-offset-0">
              Change cardform back to card-form to display it
    ...
    <script src="<?php echo SITEURL;?>/assets/js/main.js" type="text/javascript"></script>
