                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell-o"></i><span
                                    class="label label-danger"><?php echo $escaper->escapeHtml(count($data['notify'])) ?></span></a>
                            <ul class="dropdown-menu">
                                <li class="header">You have <?php echo $escaper->escapeHtml(count($data['notify'])) ?>
                                    notifications</li>
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#"><i class="fa fa-shopping-cart text-green"></i>
                                                <?php echo $escaper->escapeHtml($notif->notif_content); ?></a>
                                        </li>
                                        <?php endforeach?>
                                    </ul>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" data-pg-collapsed>
                            <div class="ov-box box-shadow">
                                <h5 class="text-left">Order Value <sup class="gray"><?php echo getMonth(TODAY) ?></sup>
                                </h5>
                                <h2><span>N<?php echo formatNumber($data['totalRevenueByMonth']) ?></span><img
                                        src="<?php echo SITEURL ?>/assets/images/svg/Arrow%20(2).svg"><span
                                        class="green">43%</span></h2>
                                        ...
                                        <table id="historyTable" class="table history no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="#"><?php echo $escaper->escapeHtml(get_formatted_date($order->order_date_added)) ?></a>
                                                    </td>
                                                    <td><?php echo $escaper->escapeHtml($order->product_name) ?></td>
                                                    <td>Enyo Retail</td>
                                                    <td>
                                                        <div class="sparkbar" data-color="#00a65a" data-height="20">
                                                            <?php echo $escaper->escapeHtml($order->order_litres) ?>
                                                            Litres</div>
                                                    </td>
                                                    <td>
                                                        <div class="sparkbar" data-color="#00a65a" data-height="20">
                                                            N<?php echo $escaper->escapeHtml(formatNumber($order->order_amount)) ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php endforeach?>
                                            ...
                                            <div class="table-responsive">
                                                <table id="partnerTable" class="table no-margin ptable">
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                <input class="control-label selectall" type="checkbox"
                                                                    value="">
                                                            </th>
                                                            <th>Partner</th>
                                                            <th>Location</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr pid="<?php echo $escaper->escapeHtml($partner->id) ?>">
                                                            <td>
                                                                <input class="control-label" class="partner_checkbox"
                                                                    data-partner-id="<?php echo $escaper->escapeHtml($partner->partner_id) ?>"
                                                                    type="checkbox" value="">
                                                            </td>
                                                            <td><span><?php echo $escaper->escapeHtml($partner->partner_name) ?></span>
                                                            </td>
                                                            <td><span><?php echo $escaper->escapeHtml($partner->partner_location) ?></span>
                                                            </td>
                                                            <td>
                                                ...
                                                <table id="driverTable" class="table no-margin ptable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr pid="<?php echo $escaper->escapeHtml($driver->id) ?>">
                                                            <td>
                                                                <input class="control-label" class="partner_checkbox"
                                                                    data-partner-id="<?php echo $escaper->escapeHtml($driver->id) ?>"
                                                                    type="checkbox" value="">
                                                            </td>
                                                            <td><span><?php echo $escaper->escapeHtml($driver->name) ?></span>
                                                            </td>
                                                            <td><span><?php echo $escaper->escapeHtml($driver->location_id) ?></span>
                                                            </td>
                                                            <td>
                                                                <button aid="<?php echo $driver->id ?>"
                                                                    id="viewDeliverAgent" type="button"
                                                                    class="btn  btn-info">view</button>
                                                            </td>
                                                            <td>
                                                                <button pid="<?php echo $driver->id ?>" type="button"
                                                                    class="btn  btn-danger delete">delete</button>
                                                            </td>
                                                        </tr>
                                                        <?php endforeach?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="password" id="npassword" name="npassword"
                                                        class="form-control input-group form-group"
                                            ...
                                            <div class="col-sm-6 col-sm-push-6">
                                                <div class="form-group text-right">
                                                    <input type="button" uid="<?php echo $_SESSION['user_id']; ?>"
                                                        class="btn btn-primary text-uppercase updatepass"
                                                        value="update">
                                                    <span class="passloader"><i
                                                            class="fa fa-pulse fa-2x  fa-spinner"></i> </span>
                                                </div>
                                            </div>
                        ...
                        <?php $prods = $data['products']?>
                            <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title">Set Delivery Prices</h3>
                                </div>
                                <div class="box-body chart-responsive">
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Petrol</label>
                                                    <input type="text" id="petrol_delivery_price"
                                                        name="petrol_delivery_price" class="form-control"
                                                        placeholder="Set Petrol delivery price"
                                                        value="<?php echo $escaper->escapeHtml($prods[0]->product_name == "Petrol" ? $prods[0]->product_delivery_price : "") ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Gas</label>
                                                    <input type="text" id="gas_delivery_price"
                                                        name="gas_delivery_price"
                                                        class="form-control input-group form-group"
                                                        placeholder="Set Gas delivery price"
                                                        value="<?php echo $escaper->escapeHtml($prods[2]->product_name == "Gas" ? $prods[2]->product_delivery_price : "") ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Desiel</label>
                                                    <input type="text" id="desiel_delivery_price"
                                                        name="desiel_delivery_price"
                                                        class="form-control input-group form-group"
                                                        placeholder="Set Desiel delivery price"
                                                        value="<?php echo $escaper->escapeHtml($prods[1]->product_name == "Diesel" ? $prods[1]->product_delivery_price : "") ?>">
                                            ...
                                            <div class="col-sm-6 col-sm-push-6">
                                                <div class="form-group text-right">
                                                    <input type="button"
                                                        class="btn btn-primary text-uppercase updateDeliveryPrices"
                                                        value="update">
                                                    <span class="passloaderD"><i
                                                            class="fa fa-pulse fa-2x  fa-spinner"></i> </span>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="pull-right">
                                                    <h2><span><?php echo $escaper->escapeHtml($product->product_price) ?></span>
                                                        per litre</h2>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title">Set Minimum Quanities</h3>
                                </div>
                                <div class="box-body chart-responsive">
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Petrol</label>
                                                    <input type="text" id="petrol_minimum_quantity"
                                                        name="petrol_minimum_quantity" class="form-control"
                                                        placeholder="Set Petrol quantity"
                                                        value="<?php echo $escaper->escapeHtml($prods[0]->product_name == "Petrol" ? $prods[0]->product_minimum_quantity : "") ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Gas</label>
                                                    <input type="text" id="gas_minimum_quantity"
                                                        name="gas_minimum_quantity"
                                                        class="form-control input-group form-group"
                                                        placeholder="Set Gas quantity"
                                                        value="<?php echo $escaper->escapeHtml($prods[2]->product_name == "Gas" ? $prods[2]->product_minimum_quantity : "") ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label>Desiel</label>
                                                    <input type="text" id="desiel_minimum_quantity"
                                                        name="desiel_minimum_quantity"
                                                        class="form-control input-group form-group"
                                                        placeholder="Set Desiel quantity"
                                                        value="<?php echo $escaper->escapeHtml($prods[1]->product_name == "Diesel" ? $prods[1]->product_minimum_quantity : "") ?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-sm-push-6">
                                                <div class="form-group text-right">
                                                    <input type="button"
                                                        class="btn btn-primary text-uppercase updateMinimumQuantity"
                                                        value="update">
                                                    <span class="passloaderM"><i
                                                            class="fa fa-pulse fa-2x  fa-spinner"></i> </span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 clear">
                                <div class="pull-right mt-30">
                                    ...
                                    <button id="createDeliveryGuy" pid="admin" class="btn btn-primary create"
